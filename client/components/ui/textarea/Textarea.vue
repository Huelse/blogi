...
const classes = computed(() =>
  cn(
    'flex min-h-24 w-full rounded-2xl border border-[var(--panel-border)] bg-[var(--field-bg)] px-4 py-3 text-sm text-[var(--title)] transition',
...
<template>
  <textarea v-model="modelValue" :class="classes" v-bind="$attrs" />
</template>
